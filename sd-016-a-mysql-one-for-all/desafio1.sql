...
CREATE TABLE SpotifyClone.history(
    `reproduction_history` TIMESTAMP,
...
INSERT INTO SpotifyClone.user (`user_name`, `user_age`, `plan_id`, `subscription_date`)
...
INSERT INTO SpotifyClone.history (`song_id`, `user_id`, `reproduction_history`)
